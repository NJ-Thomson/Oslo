...
rule fep_setup_ligand:
    ...
    shell:
        '''
            ...
            echo "1 0" | gmx trjconv -s {params.feptop_dir}/../../equil-mdsim/npt_equil2/npt_equil2.tpr -f {params.feptop_dir}/nojump.gro -o {output.fep_gro} -pbc mol -center -ur compact
            ...
            max_window={params.coul_windows}
            for i in $(seq 0 $((max_window-1)))
            do
