"""
Interactive GPCR extraction from MD trajectories.
"""
...
def extract_gpcr_interactive():
    ...
    if trajectory:
        ...
        if gmx:
            ...
            print("GROMACS not found, using MDAnalysis (slower)...")
